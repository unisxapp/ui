export default function errorStatus(error = '', value = '', token = '') {
    switch (error) {
        ...
        case 'mintExpired':
            return {isError: true, text: `Contract in expiration. The price will be finalised by ${value}.`};
        case 'setExpired':
            return {isError: false, text: 'Contract in expiration. Press Settle Expired button.'};
        case 'setExpire':
            return {isError: false, text: 'Contract in expiration. Press Expire button.'};
