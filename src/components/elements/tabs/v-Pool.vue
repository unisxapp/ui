      ...
      <div class="col-md-8 col-sm-8 col-xs-12 flex-collumn">
        <div class="flex mb-10 flex-row-2 flex j-between mb-10">
          <div class="input-wrapp">
            ...
            <div class="flex j-between mb-0">
              ...
              <span class="ml-a mw-70-ec">{{
                selectedItem.firstTokenAmountInPool
              }}</span>
              <span
          ...
          <div class="input-wrapp">
            ...
            <div class="flex j-between mb-0">
              ...
              <span
                ...
                class="color-green cur-p"
                @click="
                  handleMaxClick('firstToken', selectedItem.firstTokenInWallet)
                "
                >&nbsp;MAX</span
              >
            </div>
        ...
        <div class="flex mb-10 flex-row-2 flex j-between mb-10">
          <div class="input-wrapp">
            ...
            <div class="flex j-between mb-0">
              <span>In the pool:</span>
              <span class="ml-a mw-70-ec">{{
                selectedItem.secondTokenAmountInPool
              }}</span>
              <span
          ...
          <div class="input-wrapp">
            <input type="text" disabled v-model="selectedItem.secondToken" />
            <div class="flex j-between mb-0">
              <span>In the wallet:</span>
              ...
              <span
                ...
                @click="
                  handleMaxClick(
                    'secondToken',
                    selectedItem.secondTokenInWallet
                  )
                "
                >&nbsp;MAX</span
              >
        ...
        <div class="but_flex lr-auto">
          <button
            ...
            @click="unPool"
            :disabled="!selectedItem.firstTokenAmount"
          >
            unPool
          </button>
          <button
            ...
            @click="pool"
            :disabled="!selectedItem.secondTokenAmount"
          >
            Pool
          </button>
        </div>
  ...
  methods: {
    ...
    async handleSelectClick(e) {
      if (typeof e.target !== "undefined") {
        if (
          ...
          if (
            ["UNISWAPv2/uSPAC10-test/USDC", "UNISWAPv2/UNISX/USDC"].includes(
              value
            )
          ) {
    ...
    async pool() {
      if (
        ...
        this.selectedItem.tokenCode
      ) {
        const tokenCode =
          this.selectedItem.tokenCode === "uSPAC10-test"
            ? "uSPAC10"
            : this.selectedItem.tokenCode;
        ...
        if (+tokenAmount > +tokenInWallet) {
          this.onMessage(
            errorStatus("poolTokensCount", tokenInWallet, separate(value)[0])
          );
    ...
    async unPool() {
      if (
        ...
        if (+tokenAmount > +tokensInPool) {
          this.onMessage(
            errorStatus("unPoolTokensCount", tokensInPool, separate(value)[0])
          );
        ...
        try {
          ...
          if (
            +this.selectedItem.firstTokenAmount ===
            +this.selectedItem.firstTokenAmountInPool
          ) {
    ...
    toPrice(token) {
      switch (token) {
        case "firstToken":
          return (
            +this.selectedItem.firstTokenAmount * this.selectedItem.tokenPrice
          ).toString();
        case "secondToken":
          return (
            +this.selectedItem.secondTokenAmount / this.selectedItem.tokenPrice
          ).toString();
        default:
          return token;
      }
    ...
    async updateSelectedItem(value) {
      ...
      const firstTokenInWallet = this.PORTFOLIO.find(
      ...
      this.selectedItem.firstTokenInWallet =
        selectedItemData.tokenBalanceFormatted;
      this.selectedItem.secondTokenInWallet =
        selectedItemData.USDCBalanceFormatted;
      this.selectedItem.firstTokenAmountInPool =
        selectedItemData.tokenAvailableToWithdrawFormatted;
      this.selectedItem.secondTokenAmountInPool =
        selectedItemData.USDCAvailableToWithdrawFormatted;
      this.selectedItem.firstTokenAmount = "";
      this.selectedItem.secondTokenAmount = "";
